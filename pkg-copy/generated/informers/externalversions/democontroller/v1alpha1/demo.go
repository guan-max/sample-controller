...
import (
	...
	democontrollerv1alpha1 "k8s.io/sample-controller/pkg/apis/democontroller/v1alpha1"
	...
	v1alpha1 "k8s.io/sample-controller/pkg/generated/listers/democontroller/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Demos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Demos(namespace).Watch(context.TODO(), options)
			},
		},
