...
type DemocontrollerV1alpha1Interface interface {
	RESTClient() rest.Interface
	FoosGetter
}

// SamplecontrollerV1alpha1Client is used to interact with features provided by the samplecontroller.k8s.io group.
type DemocontrollerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DemocontrollerV1alpha1Client) Foos(namespace string) FooInterface {
...
func NewForConfig(c *rest.Config) (*DemocontrollerV1alpha1Client, error) {
	config := *c
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DemocontrollerV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &DemocontrollerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SamplecontrollerV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *DemocontrollerV1alpha1Client {
...
func New(c rest.Interface) *DemocontrollerV1alpha1Client {
